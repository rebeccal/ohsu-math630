...
<!-- To make the key -->
<!-- rmarkdown::render("misc/F18_midterm-key.Rmd", output_file = "F18_midterm-key.pdf",  params = list(key=TRUE), output_format = "pdf_document") -->

<!-- To make the exam (test) -->
<!-- rmarkdown::render("misc/F18_midterm-key.Rmd", output_file = "F18_midterm-test.pdf",  params = list(key=FALSE), output_format = "pdf_document") -->
...
Free Answer questions are worth 4 points each. Multiple Choice are each worth 2 points. 


\newpage
1. Given the probability density function of the random variable $X$ (below):
