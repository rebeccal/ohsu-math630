...
# P0: Pick a Group and a Paper

The goal of this project piece is to choose your final project teams and to pick a paper you'll use for your final project. No overlap will be allowed - that is each paper can be used by only one group. Because of this, each group should submit their top 3 choices, and we'll do what we can to accomodate. 

[Paper List](project/P0-pick-papers/P0_Groups.html)

# P1: Data Quality Review

The goal of this project piece is to look at and explore your dataset for your final project. You will use the [Quartz Bad Data Guide](https://github.com/Quartz/bad-data-guide/) to help guide your data quality review. Please use this  [`.csv`](project/P1-data-quality-review/quartz-bad-data-checklist.csv) file to indicate which, if any variable(s), in your dataset has any of the issues listed. If you indicate a variable with an issue, please include a brief paragraph (2-3 sentences tops) describing the issue further.

**Once submitted, your team will need to meet with the instructor to review your data and determine the scope of the analyses you will include in your Replication and Extension Reports.**
...
Each team has already discussed the scope of your replication in a one-on-one meeting with the Instructor. The scope was intentionally limited to those analyses/results that are based on the general linear model (t-tests, linear regression, Analysis of Variance). 
...
* A knitted HTML(or .pdf) of your final replication/extension report
    - All R code chunks should be included and visible in the final report
* The .Rmd file used to generate that HTML(or pdf)
* All data(s) needed
* All scripts needed that are called in your .Rmd file

Example report:

* [A Large-Scale Test of the Goldilocks Hypothesis](project/example-reports/math_530-630-final-project-ex3.pdf)
