...
- Confused variance! Gini_index and share_pop_hs are correlated = `r cor(hate_demo$gini_index, hate_demo$share_pop_hs)`
...
- Almost always there a bit when there are multiple predictors - especially risky with interactions
