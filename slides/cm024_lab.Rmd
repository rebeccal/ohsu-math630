...
- The structure of this lab is as follows:
  ...
  - In the next lab, you'll do: 
      - Analysis of observed/fitted values and residuals following [ModernDive](http://moderndive.com/7-multiple-regression.html#model3points)
      - Residual analysis following [ModernDive](http://moderndive.com/7-multiple-regression.html#model3residuals)
...
Recall that a [new exploratory data analysis](http://moderndive.com/6-regression.html#model1EDA) involves three things:
...
Following the narrative in [ModernDive](http://moderndive.com/7-multiple-regression.html#model3EDA), write a few sentences describing the output here.
...
> Following the narrative in [ModernDive](http://moderndive.com/12-thinking-with-data.html#house-prices-EDA-I), write a few sentences describing the output here.
...
For simple regression, we calculated correlation coefficients between the outcome and explanatory variables. For [multiple regression](http://moderndive.com/7-multiple-regression.html#model3EDA), your EDA should involve multiple correlation coefficients. We'll use the `cor()` function to do this. You'll want to first `select` only numeric variables first.
...
> Following this narrative in [ModernDive](http://moderndive.com/7-multiple-regression.html#model3EDA), write a few sentences describing the output here.
...
- Sketch out the *modeling equation* for your model (not in your R Markdown)
    - Parallel slopes example [here](http://moderndive.com/7-multiple-regression.html#model4table)
    - Interaction model [here](http://moderndive.com/7-multiple-regression.html#model4interactiontable)
