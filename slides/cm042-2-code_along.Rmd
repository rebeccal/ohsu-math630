...
#Generating the data - only needed once, or if the data is misplaced
...
```{r include = TRUE}
# Using a smaller version that dropped everything but reported heigt and id.
male_heights <- read_csv(here::here("data", "male_heights_smaller.csv"))
```
...
Now let's generate 1,000 (or less) replicates, calculate the mean for each replicate, and make a histogram to show the distribution of all the calculated means.
