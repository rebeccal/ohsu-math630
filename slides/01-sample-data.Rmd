...
# All linear list-wise operations have no effect on shape.
...
Finding $a$ and $b$, given $\bar{y}$, $s_y$, and $\bar{x}$ 
...
Take 2 minutes to solve for $a$ and $b$, in terms of $\bar{y}$, $s_y$, and $\bar{x}$
