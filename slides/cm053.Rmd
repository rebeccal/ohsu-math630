...
#summary(mcp) # Tukeys with stepwise adjusted p-value
summary(mcp,test=univariate()) # Fisher's LSD (like a set of paired-ts (pooled sd 2 groups), but with pooled sd from all groups)
```
