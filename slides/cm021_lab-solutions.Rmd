---
title: "CM 2.1 - Simple linear regression: Solutions"
...
- This lab is based on [Chapter 6: Basic Regression in ModernDive](http://moderndive.com/6-regression.html). Please open it and follow closely!
...
- The “best-fitting” regression line is “best” in that it minimizes what?
    - Make sure you read [this](http://moderndive.com/6-regression.html#leastsquares)
...
- Why is this method called "simple linear regression" (as opposed to the method in [Chapter 7](http://moderndive.com/7-multiple-regression.html))?
...
Conduct a [new exploratory data analysis](http://moderndive.com/6-regression.html#model1EDA), which involves three things:
