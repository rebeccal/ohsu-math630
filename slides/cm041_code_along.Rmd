...
sem10 <- sd(my_sim$sample_mean) # sem
n10_var = sum((my_sim$sample_mean)^2)/length(my_sim$sample_mean) - (mean(my_sim$sample_mean))^2
check_sem10 <- sqrt(n10_var)
```

2. Use the code above to run this simulation for 100,000 (or 10,000) experiments, and make a plot of the sampling distribution of the sample means. What do you see?
