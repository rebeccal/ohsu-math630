...
a) In recent years the height of women has been changing. Therefore the sample with \bar{X_{obt}} = 64.25 
is a random sample from a population where \mu \neq 63

b) It is reasonable to consider the sample with \bar{X_{obt}} = 64.25 is a random sample from a population 
where \mu = 63
