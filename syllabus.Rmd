...
What does this mean? It means that you should feel comfortable being asked to review any of the above topics, and to apply them (after demonstration) in this course.
...
* 8 points for each initial solution being "in good faith""
    ...
    - 4: answer reflects some attempt to approach the problem, but approach appears to be superficial and lacks depth of analysis.
...
## DataCamp
DataCamp provides an interactive environment for learning and practicing data science and statistics skills in R. Full points will be awarded for completing at least 80% of the assigned DataCamp chapters. Lesser proportions will receive a commensurate reduction in points.
