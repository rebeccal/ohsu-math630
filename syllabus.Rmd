---
title: DRAFT - Syllabus for Probability & Statistical Inference for Scientists and
  Engineers
...
|Lab     | 4 (plus a 0 point pre-lab) |15                     | 60           |
|Midterm | 1                  |45                     | 45           |
|Project | 5                  |5 / 10 / 15 / 20 / 25 / 25 | 100      |

The total points possible in this course is 250.
...
##Labs
There will be 5 labs in this course. The first is an ungraded pre-lab which will help you become familiar with R, RStudio, and R Markdown. This pre-lab is due before classes start and will ensure you are prepared to complete the required coursework. The remaining 4 labs will be graded. Your completed labs will be submitted as a raw R Markdown file and a knitted PDF file. You may submit (and re-submit) labs to Sakai until the following Friday at 5pm.
